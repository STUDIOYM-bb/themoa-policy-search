...
CREATE TABLE goal (
  ...
  status ENUM('진행중','완료','실패') NOT NULL,
...
CREATE TABLE savings_product (
  ...
  updated_at DATETIME NOT NULL,
  CONSTRAINT uk_savings_product UNIQUE (product_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE savings_product_option (
  ...
  reserve_type_name VARCHAR(2),
  CONSTRAINT fk_savings_option_product FOREIGN KEY (savings_product_id) REFERENCES savings_product(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE pension_product (
  ...
  close_date VARCHAR(8),
  updated_at DATETIME NOT NULL,
  CONSTRAINT uk_pension_product UNIQUE (product_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE pension_product_option (
  id INT AUTO_INCREMENT PRIMARY KEY,
  pension_product_id INT NOT NULL,
  ...
  CONSTRAINT fk_pension_option_product FOREIGN KEY (pension_product_id) REFERENCES pension_product(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE loan_product (
  ...
  close_date VARCHAR(8),
  updated_at DATETIME NOT NULL,
  CONSTRAINT uk_loan_product UNIQUE (product_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE loan_product_option (
  ...
  CONSTRAINT fk_loan_option_product FOREIGN KEY (loan_product_id) REFERENCES loan_product(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE product_bookmark (
  ...
  CONSTRAINT uk_product_bookmark UNIQUE (member_id, product_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE financial_profile (
  ...
  created_at DATETIME NOT NULL,
  CONSTRAINT fk_financial_profile_member FOREIGN KEY (member_id) REFERENCES member(id) ON DELETE CASCADE,
  CONSTRAINT fk_financial_profile_goal FOREIGN KEY (goal_id) REFERENCES goal(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE merchant_alias (
  ...
  CONSTRAINT fk_merchant_alias_category FOREIGN KEY (default_category_id) REFERENCES category(id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE merchant (
  ...
  CONSTRAINT fk_merchant_alias FOREIGN KEY (merchant_alias_id) REFERENCES merchant_alias(id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE card_transaction (
  ...
  merchant_name_raw VARCHAR(255) NOT NULL,
  ...
  memo VARCHAR(255),
  CONSTRAINT fk_card_transaction_member FOREIGN KEY (user_id) REFERENCES member(id) ON DELETE CASCADE,
  CONSTRAINT fk_card_transaction_card FOREIGN KEY (card_id) REFERENCES cards(id) ON DELETE CASCADE,
  CONSTRAINT fk_card_transaction_merchant FOREIGN KEY (merchant_id) REFERENCES merchant(id) ON DELETE SET NULL,
  CONSTRAINT fk_card_transaction_original FOREIGN KEY (original_transaction_id) REFERENCES card_transaction(id) ON DELETE SET NULL,
  CONSTRAINT fk_card_transaction_goal FOREIGN KEY (goal_id) REFERENCES goal(id) ON DELETE SET NULL,
  CONSTRAINT fk_card_transaction_category FOREIGN KEY (category_id) REFERENCES category(id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE recurring_payment_group (
  ...
  CONSTRAINT fk_recurring_group_merchant FOREIGN KEY (merchant_id) REFERENCES merchant(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE fixed_expense_candidate (
  ...
  CONSTRAINT fk_candidate_group FOREIGN KEY (recurring_group_id) REFERENCES recurring_payment_group(id) ON DELETE CASCADE,
  CONSTRAINT fk_candidate_category FOREIGN KEY (recommended_category_id) REFERENCES category(id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE fixed_expense (
  ...
  CONSTRAINT fk_fixed_expense_candidate FOREIGN KEY (candidate_id) REFERENCES fixed_expense_candidate(id) ON DELETE RESTRICT,
  CONSTRAINT fk_fixed_expense_category FOREIGN KEY (category_id) REFERENCES category(id) ON DELETE RESTRICT,
  CONSTRAINT fk_fixed_expense_card FOREIGN KEY (card_id) REFERENCES cards(id) ON DELETE SET NULL,
  CONSTRAINT fk_fixed_expense_merchant FOREIGN KEY (merchant_id) REFERENCES merchant(id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE recurring_payment_group_transaction (
  ...
  CONSTRAINT fk_group_transaction_group FOREIGN KEY (recurring_group_id) REFERENCES recurring_payment_group(id) ON DELETE CASCADE,
  CONSTRAINT fk_group_transaction_transaction FOREIGN KEY (transaction_id) REFERENCES card_transaction(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE notification (
  ...
  CONSTRAINT fk_notification_fixed_expense FOREIGN KEY (fixed_expense_id) REFERENCES fixed_expense(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE user_merchant_preferences (
  ...
  CONSTRAINT fk_preference_merchant FOREIGN KEY (merchant_id) REFERENCES merchant(id) ON DELETE CASCADE,
  CONSTRAINT fk_preference_category FOREIGN KEY (category_id) REFERENCES category(id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
