...
CREATE INDEX ix_policy_bookmark_member ON policy_bookmark (member_id);
CREATE INDEX ix_policy_calendar_member_date ON policy_calendar_event (member_id, event_date);
